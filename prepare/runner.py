...
wrappers around these functions, so what the Setup drawer reports and what a
caller of the same functions computes cannot drift. Nothing here imports Flask
or touches the request; the routes own the HTTP.
